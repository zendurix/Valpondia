...
{
	sf::Texture* texture = new sf::Texture;	LOG_NEW;
	texture->loadFromFile("../res/textures/landOfWar.png");
	background.setTexture(*texture);
	LOG("landOfWar.png......................loaded");
...
MENUopt MENU::show_menu_ret_opt()
{
	...
	background.setPosition(-40, -100);


	UIWindow UIwin(winLength, winHeight, x, y, title, options, charHeight, false, 10, &background);
