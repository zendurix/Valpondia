...
public:
	...
	inline void update_entity_systems(Entity entity)
	{
		systems[typeid(Act).name()]->update(entity);
		systems[typeid(Move).name()]->update(entity);
		systems[typeid(MoveLevel).name()]->update(entity);
	}
